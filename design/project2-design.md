...
برای هر ریسه در slept_threads:
* بررسی میکنیم آیا زمان بیدار کردن آن رسیده است.
* اگر زمان بیدار کردن آن رسیده بود وقفه ها را غیرفعال میکنیم و این ریسه را از slept_threads خارج کرده و آن را unblock میکنیم.
* وقفه ها را فعال میکنیم.
...
* با استفاده از غیرفعال کردن وقفه ها. هر ریسه که بتواند وقفه ها را غیر فعال کند مادامی که وقفه ها غیرفعال بمانند کنترل کامل را بر روی
slept_threads خواهد داست. این کار باعت جلوگیری از مسابقه میشود.
